...
const FacultyAnnouncements = () => {
  const facultyAnnouncements = announcements.filter(
    announcement => announcement.target === 'Faculty' || announcement.target === 'Both'
  );
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid gap-6 md:grid-cols-3 mb-6">
        <Card className="glass hover-lift">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-primary">{facultyAnnouncements.length}</div>
            <p className="text-xs text-muted-foreground">For faculty</p>
          </CardContent>
        </Card>
        ...
        <Card className="glass hover-lift">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-accent">
              {facultyAnnouncements.filter(a => a.target === 'Both').length}
            </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        ...
                        {announcement.target === 'Faculty' ? 'Faculty Only' : 'General'}
                      </Badge>
